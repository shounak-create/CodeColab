...
* Conversation model with exactly two members
* Normalized member-pair representation
* Duplicate conversation prevention
* Conversation creation and retrieval
* Current user conversation listing
* Direct conversation lookup between two users
* Conversation-member authorization
* Populated member profile information
* Sensitive-field protection
...
Only direct one-to-one conversations are implemented in this module. Message persistence and real-time communication are handled by later modules.
...
* Duplicate conversation prevention
* Reverse member-order protection
